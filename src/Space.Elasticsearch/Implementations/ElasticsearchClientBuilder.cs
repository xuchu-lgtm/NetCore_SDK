...
namespace Space.ElasticSearch.Implementations
{
    /// <summary>
    /// ES客户端生成器
    /// </summary>
    internal class ElasticSearchClientBuilder
    {
        ...
        /// <returns></returns>
        private IElasticClient CreateClient(ElasticSearchOptions config)
        {
        ...
        /// <returns></returns>
        private IConnectionPool CreateConnectionPool(ElasticSearchOptions config)
        {
        ...
        /// <param name="config">配置</param>
        private void ConfigSettings(ConnectionSettings settings, ElasticSearchOptions config)
        {
            // 启用验证
